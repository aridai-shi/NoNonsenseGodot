...
var tile_size = 16  # size of a tile in the Tile$TileMap
...
var hspread = 400  # horizontal spread - the bigger, the more horizontal the $TileMap is
var vspread= 400  # vertical spread - the bigger, the more vertical the $TileMap is
var cull = 0.4 # chance to cull room 
var path  # AStar pathfinding object
signal finish_mst # so that the main map function knows you've finished making the paths
func _ready():
	randomize()
	$TileMap.clear()
	make_rooms()
...
func carve_path(pos1, pos2):
	...
	for y in range(pos1.y, pos2.y, y_diff):
		...
		$TileMap.set_cell(y_x.x+x_diff, y, 1) 
